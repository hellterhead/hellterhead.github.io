...
function sendLiffMessage() {
    ...
    var userPictureUrl = "https://i.ibb.co/tczXyp1/hlth-Img-Not-Found.jpg";
    ...
    if (type == "profile") {
        sendMessages([{type: "flex", altText: "Profile " + userDisplayName, contents: {type: "bubble", hero: {type: "image", url: userPictureUrl, size: "full", aspectRatio: "1:1", aspectMode: "cover", action: {type: "uri", uri: "line://app/1655423393-n8ZBAVOl?auto=yes&type=image&downloadUrl=" + userPictureUrl + "&previewUrl=" + userPictureUrl } }, body: {type: "box", layout: "vertical", contents: [{type: "text", text: userDisplayName, align: "center", weight: "bold", color: "#000000", size: "xl"}, {type: "box", layout: "vertical", margin: "lg", spacing: "sm", contents: [{type: "text", text: userStatusMessage, wrap: true, color: "#00ccff", size: "sm", maxLines: 5, flex: 5 }] } ] }, footer: {type: "box", layout: "horizontal", spacing: "sm", contents: [{type: "button", style: "primary", height: "sm", color: "#00ccff", action: {type: "uri", label: "Official Account", uri: "https://lin.ee/11rbC7iM7"}}, {type: "button", style: "primary", height: "sm", color: "#00ccff", action: {type: "uri", label: "Profile", uri: "line://app/1655423393-n8ZBAVOl?auto=yes&type=profile"}}, {type: "spacer", size: "sm"}]}}}]); 
    } else if (type == "text") {
        sendMessages([{
            type: "text",
